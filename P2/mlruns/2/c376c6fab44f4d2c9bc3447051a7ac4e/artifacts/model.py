...
class Model():
    ...
    def create_agent(self, state_shape: int, action_shape: int) -> object:
        ...
        with self.strategy.scope():
            ...
            model.add(LSTM(20, input_shape=(10, 25), return_sequences=True, activation='relu'))
            model.add(LSTM(20, input_shape=(10, 25), return_sequences=True, activation='relu'))       
    ...
    def train(self, replay_memory: deque, done: bool) -> None:
        ...
        current_states = np.array(current_states).reshape([len(current_states), 10, 25])
        ...
        new_current_states = np.array(new_current_states).reshape([len(new_current_states), 10, 25])
