...
from P2.ddpg_model import ActorCriticModel
...
class Simulator:
    ...
    def actor_critic_simulate(self):

        self.model = ActorCriticModel(15, 7)
        ...
        for i in tqdm(range(1000)):
            ...
            while(not done):
                ...
                replay_memory.append([current_state, action, reward, new_state])      # Adding everything to the replay memory
